    ...
    return(
        <Box p={{base:'10px', xl: '90px'}} backgroundImage='/bg-main.png' backgroundRepeat='no-repeat' backgroundPosition='top right' backgroundSize='cover'>
            ...
            <SimpleGrid  mt='50px' mx={{base:'10px',md:'54px'}} columns={{base:1,lg:3}} spacing={{base:'20px',xl:'108px'}} >
                ...
                <Box mx='auto' height={{base:'28pc',}}>
                    <Box backgroundImage='/man.png' zIndex='1' width={{base:'240px',md:'306px',lg:'282px', xl:'306px'}} height='306px' position='relative' top='20px' left={{base:'26px', md:'70px',lg:'0'}} backgroundSize='contain' backgroundRepeat='no-repeat' borderRadius='50%' />
                    ...
                    <Text fontSize='40px' fontWeight='700' top='-300px' position='relative' color='#4B488D' left={{base:'0', md: '80px',lg:'0'}}>Andi Firwansyah</Text>
                    <Stack left={{base: '48px',md:'130px', lg:'40px'}} width='calc(100% - 48px)' top='-300px' position='relative' direction='row' alignItems='center'>
                        ...
                        <Text fontSize='24px' fontWeight='700' color='#4B488D'>andifirwansyah</Text>
                    </Stack>
                </Box>
            </SimpleGrid>
